...
class PaperisasiController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($datas) {
            return redirect()->route('account.paperisasi.index')->with('success-create', 'Data Paperisasi Berhasil Disimpan!');
        } else {
            return redirect()->route('account.paperisasi.index')->with('error-create', 'Data Paperisasi Gagal Disimpan!');
        }
    }
    // <!--================== END ==================-->
