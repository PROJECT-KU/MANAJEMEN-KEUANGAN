                    ...
                    <div class="d-flex justify-content-end align-items-center mb-3" style="gap: 10px;">
                        ...
                        <div class="dropdown card-header-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-3" style="min-width: 300px;">
                                ...
                                <!-- FILTER TANGGAL -->
                                <form action="{{ route('account.kategoriscopuscamp.filter') }}" method="GET">
                                    ...
                                    <div class="btn-group" style="width: 100%;">
                                        ...
                                        <a href="{{ route('account.kategoriscopuscamp.index') }}" class="btn btn-danger" style="margin-top: 30px;">
...
<script>
    ...
    document.getElementById('liveSearch').addEventListener('keyup', function() {
        ...
        timer = setTimeout(() => {
            ...
            // Fetch data tabel
            fetch(`{{ route('account.kategoriscopuscamp.search') }}?q=${encodeURIComponent(query)}`)
                .then(response => response.text())
                .then(html => {
                    const parser = new DOMParser();
                    const doc = parser.parseFromString(html, 'text/html');
                    const newTableBody = doc.querySelector('#ScopusCampTable');
                    if (newTableBody) {
                        document.getElementById('ScopusCampTable').innerHTML = newTableBody.innerHTML;
                    }
                });
        }, 300);
    });
    ...
    function Delete(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "/account/scopus-camp/kategori/delete/" + id,
                    type: "POST",
                    data: {
                        _token: token,
                        _method: "DELETE"
