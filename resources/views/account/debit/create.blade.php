        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('account.debit.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Tanggal</label>
                                    <input type="datetime-local" class="form-control" name="debit_date" placeholder="Pilih Tanggal">
