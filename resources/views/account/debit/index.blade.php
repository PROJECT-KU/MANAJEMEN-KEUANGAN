        ...
        <div class="section-body">
            ...
            @if ($maintenance->status === 'aktif' && (now() <= Carbon\Carbon::parse($maintenance->end_date)->endOfDay()))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('account.debit.search') }}" method="GET" id="searchForm">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    @if(request()->has('q'))
                                    <a href="{{ route('account.debit.index') }}" class="btn btn-danger ml-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a style="margin-right: 5px; margin-bottom:5px; width: 30px; height:30px; display: inline-flex; justify-content: center; align-items: center;" href="{{ route('account.debit.edit', $hasil->id) }}" class="btn btn-sm btn-primary">
                                    ...
                                    @if ($item->status == 'terbayar' && Auth::user()->level == 'karyawan')
                                    <tr>
                                        <th scope="row" style="text-align: center">{{ $no }}</th>
