...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <form id="kategoriForm" action="{{ route('account.kategori.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_ke" value="{{ old('nama_ke') }}" placeholder="Kategori Ke" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="total_kuota" value="{{ old('total_kuota') }}" placeholder="Masukkan Kuota" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>PPN</label>
                                    <div class="input-group">
                                        <input type="text" name="ppn" id="ppn" value="{{ old('ppn') }}" placeholder="Masukkan Total PPN" class="form-control">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">%</span>
                                        </div>
                                    </div>
