      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label>TOTAL</label>
              <input type="text" name="total" value="{{ old('total', 'Rp ' . number_format($penyewaan->total, 0, ',', '.')) }}" class="form-control" style="font-weight: bold;" readonly>
              @error('total')
              <div class="invalid-feedback" style="display: block">
                {{ $message }}
              </div>
          ...
          <a href="{{ route('account.penyewaan.index') }}"> <button class="btn btn-primary mr-1 btn-submit" type="submit"><i class="fa fa-list"></i> LIST PEMINJAMAN</button></a>
        </div>
      </div>
    </div>
  </section>
