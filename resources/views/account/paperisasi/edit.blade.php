                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-paper d-flex justify-content-center align-items-center" style="height: 100%;">
                            ...
                            <div class="text-center">
                                <p>Uploaded File: {{ basename($datas->file_anatomi) }}</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-paper d-flex justify-content-center align-items-center" style="height: 100%;">
                            ...
                            <div class="text-center">
                                <p>Uploaded File: {{ basename($datas->file_anatomi_second) }}</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-paper d-flex justify-content-center align-items-center" style="height: 100%;">
                            ...
                            <!-- Display the file name and a download link -->
                            <div class="text-center">
                                <p>Uploaded File: {{ basename($datas->file_anatomi_third) }}</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-paper d-flex justify-content-center align-items-center" style="height: 100%;">
                            ...
                            <!-- Display the file name and a download link -->
                            <div class="text-center">
                                <p>Uploaded File: {{ basename($datas->file_paper_second) }}</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-paper d-flex justify-content-center align-items-center" style="height: 100%;">
                            ...
                            <!-- Display the file name and a download link -->
                            <div class="text-center">
                                <p>Uploaded File: {{ basename($datas->file_paper_third) }}</p>
