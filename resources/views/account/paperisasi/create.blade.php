                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="datetime-local" name="tanggal_masuk_paper" value="{{ old('tanggal_masuk_paper') }}" placeholder="Masukkan Tanggal Masuk Paper" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="first_author" value="{{ old('first_author') }}" placeholder="Masukkan Nama First Author" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="affiliasi_first_author" value="{{ old('affiliasi_first_author') }}" placeholder="Masukkan Affiliasi First Author" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="co_author" value="{{ old('co_author') }}" placeholder="Masukkan Nama CO-Author" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="affiliasi_co_author" value="{{ old('affiliasi_co_author') }}" placeholder="Masukkan Affiliasi CO-Author" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="jurnal_target" value="{{ old('jurnal_target') }}" placeholder="Masukkan Nama Jurnal Target" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="q_jurnal" value="{{ old('q_jurnal') }}" placeholder="Masukkan Quartile Jurnal" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="estimasi_terbit" value="{{ old('estimasi_terbit') }}" placeholder="Masukkan Estimasi Terbit Paper" class="form-control" required>
                                        <div class="input-group-prepend">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="apc_jurnal" value="{{ old('apc_jurnal') }}" placeholder="Masukkan APC Jurnal" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="datetime-local" name="progres_anatomi_tanggal" value="{{ old('progres_anatomi_tanggal') }}" placeholder="Masukkan Tanggal Pengerjaan Anatomy" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="progres_anatomi_estimasi" value="{{ old('progres_anatomi_estimasi') }}" placeholder="Masukkan Estimasi Pengerjaan" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="progres_anatomi_keterangan" value="{{ old('progres_anatomi_keterangan') }}" placeholder="Masukkan Keterangan" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="progres_anatomi_status">
                                ...
                                <option value="in progress anatomy">PENGERJAAN ANATOMY</option>
                                <option value="revisi anatomy">REVISI ANATOMY</option>
                                <option value="done anatomy">ANATOMY SELESAI</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tanggal Pengerjaan</label>
                            <div class="input-group">
                                <input type="datetime-local" name="progres_anatomi_tanggal_second" value="{{ old('progres_anatomi_tanggal_second') }}" placeholder="Masukkan Tanggal Pengerjaan Anatomy" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Estimasi Pengerjaan </label>
                            <div class="input-group">
                                <input type="text" name="progres_anatomi_estimasi_second" value="{{ old('progres_anatomi_estimasi_second') }}" placeholder="Masukkan Estimasi Pengerjaan" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Keterangan</label>
                            <div class="input-group">
                                <input type="text" name="progres_anatomi_keterangan_second" value="{{ old('progres_anatomi_keterangan_second') }}" placeholder="Masukkan Keterangan" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-anatomy">
                            ...
                            <span id="file-selected-anatomy-second" class="file-info-anatomy"></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tanggal Pengerjaan</label>
                            <div class="input-group">
                                <input type="datetime-local" name="progres_anatomi_tanggal_third" value="{{ old('progres_anatomi_tanggal_third') }}" placeholder="Masukkan Tanggal Pengerjaan Anatomy" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Estimasi Pengerjaan </label>
                            <div class="input-group">
                                <input type="text" name="progres_anatomi_estimasi_third" value="{{ old('progres_anatomi_estimasi_third') }}" placeholder="Masukkan Estimasi Pengerjaan" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Keterangan</label>
                            <div class="input-group">
                                <input type="text" name="progres_anatomi_keterangan_third" value="{{ old('progres_anatomi_keterangan_third') }}" placeholder="Masukkan Keterangan" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-anatomy">
                            ...
                            <span id="file-selected-anatomy-third" class="file-info-anatomy"></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tanggal Pengerjaan</label>
                            <div class="input-group">
                                <input type="datetime-local" name="progres_paper_tanggal" value="{{ old('progres_paper_tanggal') }}" placeholder="Masukkan Tanggal Pengerjaan Paper" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Estimasi Pengerjaan </label>
                            <div class="input-group">
                                <input type="text" name="progres_paper_estimasi" value="{{ old('progres_paper_estimasi') }}" placeholder="Masukkan Estimasi Pengerjaan" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Keterangan</label>
                            <div class="input-group">
                                <input type="text" name="progres_paper_keterangan" value="{{ old('progres_paper_keterangan') }}" placeholder="Masukkan Keterangan" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="progres_paper_status">
                                <option value="" disabled selected>-- PILIH STATUS PAPER --</option>
                                <option value="in progress paper">PENGERJAAN PAPER</option>
                                <option value="revisi paper">REVISI PAPER</option>
                                <option value="done paper">PAPER SELESAI</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-paper">
                            ...
                            <span id="file-selected-paper" class="file-info-paper"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tanggal Pengerjaan</label>
                            <div class="input-group">
                                <input type="datetime-local" name="progres_paper_tanggal_second" value="{{ old('progres_paper_tanggal_second') }}" placeholder="Masukkan Tanggal Pengerjaan Paper" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Estimasi Pengerjaan </label>
                            <div class="input-group">
                                <input type="text" name="progres_paper_estimasi_second" value="{{ old('progres_paper_estimasi_second') }}" placeholder="Masukkan Estimasi Pengerjaan" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Keterangan</label>
                            <div class="input-group">
                                <input type="text" name="progres_paper_keterangan_second" value="{{ old('progres_paper_keterangan_second') }}" placeholder="Masukkan Keterangan" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-paper">
                            ...
                            <span id="file-selected-paper-second" class="file-info-paper"></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tanggal Pengerjaan</label>
                            <div class="input-group">
                                <input type="datetime-local" name="progres_paper_tanggal_third" value="{{ old('progres_paper_tanggal_third') }}" placeholder="Masukkan Tanggal Pengerjaan Paper" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Estimasi Pengerjaan </label>
                            <div class="input-group">
                                <input type="text" name="progres_paper_estimasi_third" value="{{ old('progres_paper_estimasi_third') }}" placeholder="Masukkan Estimasi Pengerjaan" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Keterangan</label>
                            <div class="input-group">
                                <input type="text" name="progres_paper_keterangan_third" value="{{ old('progres_paper_keterangan_third') }}" placeholder="Masukkan Keterangan" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image-preview-container-paper">
                            ...
                            <span id="file-selected-paper-third" class="file-info-paper"></span>
                        </div>
                    </div>
                </div>
            </div>
