                        ...
                        <div class="table-responsive">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="column-width" style="text-align: center;">AFILIASI</th>
                                            <th scope="col" class="column-width" style="text-align: center;">JOURNAL</th>
                                            <th scope="col" class="column-width" style="text-align: center;">SUBMIT</th>
                                ...
                                <div style="text-align: center;">
                                    ...
                                    {{ $peserta->appends(['tanggal_awal' => $startDate, 'tanggal_akhir' => $endDate])->links("vendor.pagination.bootstrap-4") }}
                                </div>
