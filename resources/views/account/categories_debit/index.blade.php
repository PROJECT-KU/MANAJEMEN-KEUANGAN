        ...
        <div class="section-body">
            ...
            @if ($maintenance->status === 'aktif' || ($maintenance->end_date !== null && now() <= Carbon\Carbon::parse($maintenance->end_date)->endOfDay()))
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('account.categories_debit.search') }}" method="GET" id="searchForm">
                        ...
                        <div class="row">
                            <div class="col-12 mt-3">
                                <div class="form-group text-center">
                                    <div class="input-group mb-3">
                                        <a href="{{ route('account.categories_debit.create') }}" class="btn btn-primary btn-block" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH KATEGORI</a>
                                    </div>
                                </div>
                            </div>
                        </div>
