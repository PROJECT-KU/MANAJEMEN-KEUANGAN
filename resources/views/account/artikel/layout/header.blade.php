...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('assets/img/scopus.png') }}" rel="icon">
    <link href="{{ asset('assets/img/scopus.png') }}" rel="apple-touch-icon">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-2 col-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li><i class="bi bi-chevron-right"></i> <a href="#">Accompaniment</a></li>
