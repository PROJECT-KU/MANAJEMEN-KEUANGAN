            ...
            <div class="section-body">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" rowspan="2" class="column-width" style="text-align: center;">ID PENGAJUAN</th>
                                        <th scope="col" rowspan="2" class="column-width" style="text-align: center;">NAMA KARYAWAN</th>
                                        <th scope="col" rowspan="2" class="column-width" style="text-align: center;">JENIS CUTI</th>
                                        <th scope="col" colspan="2" class="column-width" style="text-align: center;">TANGGAL CUTI</th>
                                    ...
                                    <tr>
                                        <th scope="col" style="text-align: center;">MULAI CUTI</th>
                                        <th scope="col" style="text-align: center;">SELESAI CUTI</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php
                                    ...
                                    <tr>
                                        ...
                                        <td class="column-width" style="text-align: center;">{{ $hasil->id_pengajuan }}</td>
                                        <td class="column-width" style="text-align: center;">{{ $hasil->full_name }}</td>
                                        <td class="column-width" style="text-align: center;">{{ $hasil->jenis_cuti }}</td>
                                        <td class="column-width" style="text-align: center;">{{ $hasil->tanggal_mulai_cuti }}</td>
                                        <td class="column-width" style="text-align: center;">{{ $hasil->tanggal_selesai_cuti }}</td>
                            ...
                            <div style="text-align: center;">
                                ...
                                {{ $DatasAjukan->appends(['tanggal_awal' => $startDate, 'tanggal_akhir' => $endDate, 'status' => 'diajukan'])->links("vendor.pagination.bootstrap-4") }}
                            </div>
                        </div>
                ...
                <div id="tableDiterima" class="card">
                    <div id="tblDiajukan" class="card-header" style="background-color: #63ED7A; color:white;">
                        <h4 class="d-none d-sm-block"><i class="fas fa-list"></i> DATA CUTI KARYAWAN DITERIMA</h4>
                ...
                <div id="tableDitolak" class="card">
                    <div id="tblDiajukan" class="card-header" style="background-color: #FC554B; color:white;">
                        <h4 class="d-none d-sm-block"><i class="fas fa-list"></i> DATA CUTI KARYAWAN DITOLAK</h4>
