                    ...
                    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                        <center>
                            <div class="card mt-5 mb-5" style="width: 35rem;">
                                ...
                                <div class="card-body">
                                    <p style="font-weight: bold; font-size: 35px;">Hallo, {{ $pendaftaran->nama }}</p>
                                    <p style="font-size: 15px;">Terima kasih sudah melakukan pendaftaran Scopus Camp! Pendaftaran Scopus Camp anda sudah kami terima, berikut rinciannya:</p>
                                    <div class="card_dalam" style="display: flex; justify-content: space-between; flex-wrap: wrap;">
                                        ...
                                        <div class="card-body mobile" style="color: black; text-align: left; flex: 1; margin-right: 25px; margin-left:180px;">
                                            <div style="text-align: right;">
                                                <p>{{ strtoupper($pendaftaran->id_transaksi) }}</p>
                                                <p>{{ strftime('%d %B %Y', strtotime($categoriesScopusCamp->mulai)) }}</p>
                                                <p>{{ strftime('%d %B %Y', strtotime($categoriesScopusCamp->selesai)) }}</p>
                                                <p>{{ $categoriesScopusCamp->nama }} #{{ $categoriesScopusCamp->nama_ke }} </p>
                                                <p>{{ $categoriesScopusCamp->lokasi }}</p>
                                                <p>Rp. {{ number_format($pendaftaran->total_pembayaran, 0, ',', '.') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <p style="font-size: 15px;">Status pendaftaran Scopus Camp anda saat ini <b>Sudah Di Terima</b>. Silahkan masuk ke dalam WhatsApp Grup yang telah kami sedikan, dengan mengklik link berikut</p>
                                    <p style="font-size: 18px;">{{ $categoriesScopusCamp->group_wa }}</p>
