...
@section('title')
Update Perjalanan Dinas Ditolak | MIS
@stop
...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      <h1>PERJALANAN DINAS DITOLAK</h1>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('account.PerjalananDinas.updateDitolak', $DatasDitolak->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="user_id" id="karyawanSelect" style="width: 100%" disabled>
                    ...
                    <option value="{{ $user->id }}" {{ $user->id == $DatasDitolak->user_id ? 'selected' : '' }}>{{ $user->full_name }}</option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" name="status" disabled>
                      ...
                      <option value="diterima" {{ $DatasDitolak->status == 'diterima' ? 'selected' : '' }}>DITERIMA</option>
                      <option value="ajukan" {{ $DatasDitolak->status == 'ajukan' ? 'selected' : '' }}>AJUKAN</option>
                      <option value="ditolak" {{ $DatasDitolak->status == 'ditolak' ? 'selected' : '' }}>DITOLAK</option>
                    </select>
                    @else
                    <select class="form-control" name="status" disabled>
                      <option value="" disabled selected>-- PILIH STATUS --</option>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nama Camp</label>
                  <div class="input-group">
                    <input type="text" name="tempat" value="{{ $DatasDitolak->tempat }}" placeholder="Masukkan Nama Camp" class="form-control" style="text-transform:uppercase;">
                  </div>
                  @error('tempat')
                  <div class="invalid-feedback" style="display: block">
                    {{ $message }}
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" name="camp" value="{{ $DatasDitolak->camp }}" placeholder="Masukkan Nomor Camp Ke" class="form-control">
                  </div>
                  @error('camp')
                  <div class="invalid-feedback" style="display: block">
                    {{ $message }}
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Tanggal Mulai Camp</label>
                  <input type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ \Carbon\Carbon::parse($DatasDitolak->tanggal_mulai)->format('Y-m-d') }}" placeholder="Masukkan Total Tunjangan" class="form-control">
                </div>
                @error('tanggal_mulai')
                <div class="invalid-feedback" style="display: block">
                  {{ $message }}
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Tanggal Berakhir Camp</label>
                  <input type="date" name="tanggal_akhir" id="tanggal_akhir" value="{{ \Carbon\Carbon::parse($DatasDitolak->tanggal_akhir)->format('Y-m-d') }}" placeholder="Masukkan Total Tunjangan" class="form-control">
                </div>
                @error('tanggal_akhir')
                <div class="invalid-feedback" style="display: block">
                  {{ $message }}
        ...
        <div class="card card-field4">
          ...
          <div class="card-body">
            ...
            <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#additionalInputsAccordion">
              ...
              <!--================== INPUT 36 ==================-->
              @if($DatasDitolak->uang_keluar36 !== null)
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label style=" font-weight: bold;">Catatan</label>
                  <div class="input-group" style=" border: 2px solid 	#FFA500; border-radius: 8px;">
                    <textarea type="text" name="deskripsi" placeholder="Masukan Catatan" class="form-control">{{ $DatasDitolak->deskripsi }}</textarea>
                  </div>
                </div>
              </div>
            </div>
