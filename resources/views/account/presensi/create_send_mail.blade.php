            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                        ...
                        <p>Yeay, presensi masuk kamu pada tanggal <b>{{ strftime('%d %B %Y', strtotime($presensi->created_at)) }}</b> pukul <b>{{ strftime('%H:%M', strtotime($presensi->created_at)) }}</b> dengan status <b>{{ strtoupper($presensi->status) }}</b> berhasil.</p>
                        <p>Semangat Bekerja ya!, Jangan lupa jaga kesehatan.</p>
