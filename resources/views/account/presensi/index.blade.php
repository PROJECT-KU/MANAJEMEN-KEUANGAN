              ...
              <div class="dropdown card-header-action">
                ...
                <div class="dropdown-menu dropdown-menu-right p-3" style="min-width: 300px;">
                  ...
                  <form action="{{ route('account.presensi.filter') }}" method="GET">
                    ...
                    <a href="{{ route('account.presensi.index') }}" class="btn btn-danger btn-block">
                  ...
                  <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('account.laporan_presensi.download-pdf', ['tanggal_awal' => $startDate, 'tanggal_akhir' => $endDate, 'q' => request('q')]) }}" class="btn btn-primary mr-2" style="flex: 1 1 auto; max-width: 180px;">
