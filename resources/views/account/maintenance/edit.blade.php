                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="start_date" name="start_date" value="{{ $maintenance->start_date }}" placeholder="Masukkan Mulai Maintenance" class="form-control datetimepicker" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="end_date" name="end_date" value="{{ $maintenance->end_date }}" placeholder="Masukkan Berakhir Maintenance" class="form-control datetimepicker" required>
