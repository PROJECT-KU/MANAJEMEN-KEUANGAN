@extends('public.plagiasi.layout.header')
    ...
    <div class="container justify-content-start">
        <div class="row">
            <div class="col-lg-6 d-flex flex-column justify-content-center">
                ...
                <h2 data-aos="fade-up" data-aos-delay="400" style="font-size: 15px;">Jangan takut untuk gagal, karena kegagalan adalah bagian dari perjalanan menuju sukses</h2>
