...
@section('title')
Detail Scopus Camp | Rumah Scopus
@stop
...
<style>
    ...
    /* Latar belakang abstrak agar efek kaca terlihat nyata */
    .blog-section::before {
        content: '';
        position: absolute;
        top: -10%;
                ...
                <div class="main-article">
                    <article class="glass-panel">
                        ...
                        <div class="glass-image-wrapper" style="aspect-ratio: 16/9;">
                            <img src="{{ asset('assets/img/public/scopuscamp.png') }}" alt="Cover Scopus Camp">
                        </div>
                        ...
                        <div class="meta-grid">
                            ...
                            <div class="meta-card">
                                ...
                                <div class="meta-text">
                                    ...
                                    <span class="meta-value">Rp {{ number_format($item->total_biaya, 0, ',', '.') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="meta-card">
                                ...
                                <div class="meta-text">
                                    ...
                                    <span class="meta-value">{{ $item->lokasi }}</span>
                                </div>
                            </div>
                        </div>
